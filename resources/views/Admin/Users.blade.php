...
@section('content')
    <div class="space-y-8 max-w-7xl mx-auto p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4">
                    ...
                    <div class="lg:col-span-4 flex items-end gap-5">
                        ...
                        <button onclick="resetFilter()"
                            class="flex-1 px-6 py-2.5 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition shadow-sm text-sm">
                            Reset
                        </button>
                    </div>
        ...
        {{-- MODAL DETAIL --}}
        <div id="detailModal"
            class="fixed inset-0 bg-black/70 flex items-center justify-center z-50 hidden backdrop-blur-md">
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-3xl w-full mx-4 transform transition-all duration-300 scale-95 opacity-0"
                id="detailContent">
                <div
                    class="bg-gradient-to-r from-teal-600 to-teal-700 px-6 py-4 text-white flex items-center justify-between">
                    <div class="flex items-center gap-3">
            ...
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-3xl w-full mx-4 transform transition-all duration-300 scale-95 opacity-0"
                ...
                <div class="p-6 bg-gray-50 space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-700 mb-1.5">
                                <i class="fas fa-at text-teal-600 text-sm"></i> Username <span
                                    class="text-red-500">*</span>
                            </label>
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-700 mb-1.5">
                                <i class="fas fa-lock text-teal-600 text-sm"></i> Password <span
                                    class="text-red-500">*</span>
                            </label>
                            <div class="relative">
        ...
        <script>
            ...
            function renderTable() {
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50/50 transition-colors" id="row-${user.id}">
                    ...
                    <td class="px-6 py-4">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${sBadge}">${sLabel}</span>
                    </td>
                    <td class="px-6 py-4">
